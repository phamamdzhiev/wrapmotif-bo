...
class PaymentController extends Controller
{
    ...
    public function order(OrderRequest $request)
    {
        $order = DB::transaction(function () use ($request) {
            ...
            $this->charge($order->customerGrandTotal, $order->customerCurrency, $request->token, "Order({$order->id}) from Wrapmotif");
            return $order;
        });
    ...
    public function customOrder(CustomOrderRequest $request)
    {
        $customOrder = DB::transaction(function () use ($request) {
            ...
            $this->charge($customOrder->customerGrandTotal, $customOrder->customerCurrency, $request->token, "Custom order({$customOrder->id}) from Wrapmotif");
            return $customOrder;
        });
    ...
    public function colorChange(ColorChangeRequest $request)
    {
        $colorChange = DB::transaction(function () use ($request) {
            ...
            $this->charge($colorChange->customerGrandTotal, $colorChange->customerCurrency, $request->token, "Color Change Request ({$colorChange->id}) from Wrapmotif");
            return $colorChange;
        });
    ...
    public function previewDesign(PreviewDesignRequest $request)
    {
        ...
        $previewDesign = DB::transaction(function () use ($request) {
            ...
            $this->charge($previewDesign->customerGrandTotal, $previewDesign->customerCurrency, $request->token, "Preview Design Request ({$previewDesign->id}) from Wrapmotif");
