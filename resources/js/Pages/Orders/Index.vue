        ...
        <div class="bg-white rounded-md shadow overflow-x-auto">
            <table class="w-full divide-y divide-gray-200" v-if="orders.data.length">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">customer
                        name
                    </th>

                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Grand
                        Total
                    </th>
                ...
                <tr v-for="(row, index) in orders.data" :key="index">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <strong>{{ (row.status) === 0 ? 'Pending' : 'Paid' }}</strong>
                    </td>
