    <div class="sidebar h-screen absolute lg:relative bg-gray-900 transform -translate-x-full lg:translate-x-0 transition lg:transition-none duration-500 ease-in-out z-20 overflow-x-hidden"
        :class="{ expanded: expanded }">
        <div class="sidebar__header">
            <inertia-link class="flex items-center px-4" :href="route('dashboard')">
                <jet-application-mark class="block h-8 mr-2" />
                <span class="text-xl font-bold text-white">Wrapmotif</span>
            </inertia-link>
        </div>
        ...
        <ul class="overflow-y-auto">
            ...
            <!--Custom order page  -->
            <sidebar-item :href="route('appearance.custom-orders')"
                :active="route().current('appearance.custom-orders')">
